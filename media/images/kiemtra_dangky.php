...
<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6946): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6954): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6956): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6958): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6961): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6962): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6966): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6967): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6970): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6972): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6975): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6977): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6981): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6982): ?>

<option value="<?=$donvi->get('DV_ID') ?>"><?=$donvi->get('DV_TEN') ?></option>
<?php elseif ($donvi->get('DV_ID')==6983): ?>
